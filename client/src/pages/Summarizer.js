...
const Summarizer = () => {
  ...
  const generateSummary = () => {
    return `Summary for ${callData.clientName}:

Next Steps:
1. Research first-time homebuyer programs in ${callData.clientPreferences.preferredLocations.join(' and ')}
2. Prepare mortgage pre-qualification documents
3. Schedule property viewing tour within budget of $${callData.clientPreferences.budget}

Client Preferences:
- Target Timeframe: ${callData.clientPreferences.timeframe}
- Budget Range: ${callData.clientPreferences.budget}
- Preferred Locations: ${callData.clientPreferences.preferredLocations.join(', ')}`;
  };
    ...
    <div className="bg-[#D7CCC8] min-h-screen p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card className="bg-[#EFEBE9] shadow-lg border-[#795548] border">
          ...
          <CardContent>
            <pre className="whitespace-pre-wrap text-[#4E342E]">
              {generateSummary()}
            </pre>
          </CardContent>
        </Card>
